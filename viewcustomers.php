...
<body style="background-color:#8F00FF;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark  fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\" alt=""
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; margin-top:-70px; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
...
?>
            <table class="table table" style="margin-top: 30px; background-color:orange">
                <thead>
                    <tr>
                        <th scope="col" style="background-color:Yellow">Name</th>
                        <th scope="col" style="background-color:Pink">Email</th>
                        <th scope="col" style="background-color:Yellow">Account No</th>
                        <th scope="col" style="background-color:Pink">Balance</th>
                        <th scope="col" style="background-color:Yellow">Send Money From</th>
                    </tr>
                </thead>
